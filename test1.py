...
class Fumar(Thread): #Thread para controlar cuando fumar
	...
	def poder_fumar(self, tipo,mesa):#verifica si puede fumar
	...
	def run(self):#revisa en cada instante si puede fumar
		...
		while not check:#revia si puede fumar
			check=self.poder_fumar(self.tipo,mesa)
...
Fumador_cerillos = Fumar("cerillos",1)#inicializa los Thread
Fumador_tabaco = Fumar("tabaco",2)
Fumador_papel = Fumar("papel",3)
Fumador_cerillos.start()
Fumador_papel.start()
Fumador_tabaco.start()
while cnt < n :
